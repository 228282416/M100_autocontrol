...
private:
    ...
    void center_subscriber_callback(opencv::Center center)
    {
        this->center = center;
    }
...
public:
		...
		waypoint_navigation_action_client(nh, "dji_sdk/waypoint_navigation_action", true)
	{
		...
		rc_channels_subscriber = nh.subscribe<dji_sdk::RCChannels>("dji_sdk/rc_channels", 10, &DJIDrone::rc_channels_subscriber_callback, this);
            ...
            center_subscriber = nh.subscribe<opencv::Center>("chatter",10, &DJIDrone::center_subscriber_callback,this);
//		ultrasonic_subscriber = nh.subscribe<sensor_msgs::LaserScan>("/guidance/ultrasonic",1, &DJIDrone::ultrasonic_subscriber_callback,this);
